...
def _try_passwordless_paramiko(server, keyfile):
    ...
    if policy_name:
        ...
        # Using AutoAddPolicy to accept new keys automatically (you can use RejectPolicy for more security)
...
def paramiko_tunnel(
    ...
    # Using AutoAddPolicy to accept new keys automatically (you can replace with RejectPolicy for more security)
    client.set_missing_host_key_policy(paramiko.AutoAddPolicy())
    ...
    channel = transport.open_channel(
        'direct-tcpip', (remoteip, rport), ('127.0.0.1', lport)
    )
    return channel


def _split_server(server):
    """Split user@host:port into username, host, and port."""
    user = None
    host = None
    port = 22
    if '@' in server:
